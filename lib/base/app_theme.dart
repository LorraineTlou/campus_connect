...
class AppTheme {
  static ThemeData lightTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      titleLarge: TextStyle(color: AppColors.black, fontSize: 22, fontWeight: FontWeight.bold),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      titleLarge: TextStyle(color: Color(0xFFE2E8F0), fontSize: 22, fontWeight: FontWeight.bold),
      titleMedium: TextStyle(color: Color(0xFFE2E8F0), fontSize: 18, fontWeight: FontWeight.w600),
    ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
      border: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide.none),
      enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: const BorderSide(color: Color(0xFF2D3148))),
      focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: const BorderSide(color: AppColors.primary, width: 2)),
      errorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: const BorderSide(color: AppColors.error)),
      focusedErrorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: const BorderSide(color: AppColors.error, width: 2)),
    ),

    cardTheme: const CardThemeData(color: Color(0xFF1A1D27), elevation: 2),
    ...
    dividerTheme: const DividerThemeData(color: Color(0xFF2D3148), thickness: 1),
  );
}